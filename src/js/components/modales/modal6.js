    ...
    return (
      <div>
		<Container className="dr-example-container pb-3" >
            <Row>
                ...
                <Card >
                    <CardBody className="text-center">
                        <CardTitle>Tabla con el conteo de eventos realizados</CardTitle>
                        <hr style={{ backgroundColor: '#003f72', width: "85%", height: "3px"}}/>
                        En esta tabla se muestra un conteo total de eventos agrupados por fecha y por tipo de evento.
            ...
            <ModalBody>
            <ListGroup>
                    <ListGroupItem><strong>1. </strong>Un evento es una acción realizada dentro de la plataforma.</ListGroupItem>
                </ListGroup>
                <hr style={{ backgroundColor: '#003f72', width: "85%", height: "3px"}}/>
                <ListGroup>
