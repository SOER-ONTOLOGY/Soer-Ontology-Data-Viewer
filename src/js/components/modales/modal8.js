		...
		<Container className="dr-example-container pb-3" >
            <Row>
                ...
                <Card >
                    <CardBody className="text-center">
                        <CardTitle>Tabla del conteo de bloques creados por usuarios</CardTitle>
                        <hr style={{ backgroundColor: '#003f72', width: "85%", height: "3px"}}/>
                        En esta tabla se muestra el conteo total de bloques creados por usuarios, agrupados por tipo de bloques.
            ...
            <ModalBody>
                <ListGroup>
                    ...
                    <ListGroupItem><strong>Unidades: </strong>Refiere a los bloques tipo vertical.</ListGroupItem>
                </ListGroup>
                <hr style={{ backgroundColor: '#003f72', width: "85%", height: "3px"}}/>
                <ListGroup>
