		...
		<Container className="dr-example-container pb-3" >
            <Row>
                ...
                <Card >
                    <CardBody className="text-center">
                        <CardTitle>Gráfica de barras apilada con el promedio de cambios por evento</CardTitle>
                        <hr style={{ backgroundColor: '#003f72', width: "85%", height: "3px"}}/>
                        Esta gráfica muestra datos cuantitativos continuos, los cuales permiten visualizar el promedio de cambios que ha realizado cada usuario en un evento determinado, permitiendo así ver el aporte de cada uno de ellos.
            ...
            <ModalBody>
                <ListGroup>
                    ...
                    <ListGroupItem><strong>2. </strong>Las etiquetas en cada barra, representan el nombre del evento.</ListGroupItem>
