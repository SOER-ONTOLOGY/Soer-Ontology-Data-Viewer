...
export const buildRadarData = (data, depA, depB, depC) => ({
	labels: ['Configuración de detalles', 'Configuración de equipo', 'Creación de sección', 'Creación de subsección', 'Creación de unidad', 'Edición de sección', 'Edición de subsección', 'Edición del contenido del curso', 'Libros'],
	datasets: [
		{
			label: depA.label,
